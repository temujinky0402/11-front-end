    ...
    return(
        <div class="w-full h-screen grid grid-cols-13 gap-2 bg-slate-900 p-2">
            <div class=" h-full w-full bg-blue-950 rounded-xl flex flex-col items-center">
                <img src="https://cdn-icons-png.flaticon.com/512/5024/5024369.png" class="w-[50%] h-[7%] bg-blue-900 rounded-xl p-2 mt-5"></img>
                <div class=" w-full h-[50%] flex flex-col mt-10">
                    <div class="w-[60%] h-[30%] flex items-center ml-5 flex-col">
                        <img src="https://cdn-icons-png.flaticon.com/128/3406/3406977.png" class="h-[50%] w-[50%]"></img>
                        <p class="text-blue-300">Weather</p>
                    </div>
                    <div class="w-[60%] h-[30%] flex items-center ml-5 flex-col">
                        <img src="https://cdn-icons-png.flaticon.com/128/561/561184.png" class="h-[35%] w-[50%]"></img>
                        <p class="text-blue-300">Cities</p>
                    </div>
                    <div class="w-[60%] h-[30%] flex items-center ml-5 flex-col">
                        <img src="https://cdn-icons-png.flaticon.com/128/876/876205.png" class="h-[35%] w-[50%]"></img>
                        <p class="text-blue-300">Map</p>
                    </div>
                    <div class="w-[60%] h-[30%] flex items-center ml-5 flex-col">
                        <img src="https://cdn-icons-png.flaticon.com/128/992/992668.png" class="h-[35%] w-[50%]"></img>
            ...
            <div class=" h-full w-full bg-slate-900 col-span-8 rounded-xl flex flex-col"> 
                ...
                <div class="w-full h-[30%] bg-slate-900 flex justify-between p-5 pl-10 mt-3">
                    ...
                    <img src="https://cdn-icons-png.flaticon.com/128/4814/4814268.png" class="mr-10"></img>
                </div>
            ...
            <div class=" h-auto w-full bg-blue-950 col-span-4 rounded-xl mt-14 p-8">
                ...
                <div class="w-full flex flex-row justify-between items-center mt-5">
                    ...
                    <div class="w-auto flex flex-row justify-center items-center">
                        <img src="https://cdn-icons-png.flaticon.com/128/4814/4814268.png" class="w-[20%] h-[20%]"></img>
                ...
                <div class="w-full flex flex-row justify-between items-center mt-5">
                    ...
                    <div class="w-auto flex flex-row justify-center items-center">
                        <img src="https://cdn-icons-png.flaticon.com/128/14440/14440334.png" class="w-[20%] h-[20%]"></img>
                ...
                <div class="w-full flex flex-row justify-between items-center mt-5">
                    ...
                    <div class="w-auto flex flex-row justify-center items-center">
                        <img src="https://cdn-icons-png.flaticon.com/128/4088/4088981.png" class="w-[20%] h-[20%]"></img>
                ...
                <div class="w-full flex flex-row justify-between items-center mt-5">
                    ...
                    <div className="w-auto flex flex-row justify-center items-center">
                        <img src="https://cdn-icons-png.flaticon.com/128/3982/3982078.png" className="w-[20%] h-[20%]"></img>
